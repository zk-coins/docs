...
**zkCoins v1 does not provide the paper's arbitrary-depth reorg recovery. It fixes finality at 6 confirmations and treats a ≥6-block reorg as an accepted break.**
