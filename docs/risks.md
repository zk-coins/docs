...
| Send-output redirection, change-drop (burn), or **account freeze** by a dishonest **own** node (consumes `Pkᵢ`) | **accepted v1 boundary** (D-17) | thin-client rule; self-host/vet mitigations |
