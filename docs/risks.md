...
| Carrying real Bitcoin | **holds** (out of this protocol catalog) | native assets settle on Bitcoin L1 and need no bridge; 1:1 BTC is specified in [`zk-coins/zkbtc`](https://github.com/zk-coins/zkbtc/blob/main/spec/ZKBTC_TOKEN.md) (effectively-trustless claim: §1.1.1), outside this document's token-standard catalog |
