...
BalanceAttestation:
  ...
  witness (hidden):
    { AccountState S,
      ...
      size, size_ceiling,                             // u64 sizes (and tree-heads mth, mth_ceiling) of the attested nav and the disclosed nav_ceiling
