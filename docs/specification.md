...
- **Class A / Class B** — the two serving classes of [§4.6](#46-data-availability): Class A is a subject's recipient-private records (ownership- or grant-gated); Class B is issuer-originated token provenance (`asset_terms`), openly resolvable by `asset_id`. ([§4.6](#46-data-availability))
