...
All key material descends deterministically from a single **seed** that roots the BIP-32 tree. The mnemonic that produces the seed is the only thing a user backs up ([Requirement 6](/requirements)).
