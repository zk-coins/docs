...
| `SubmitTransition` | `malformed_request`/`400`, `bounds_exceeded`/`400`, `invalid_input_coin`/`400`, `insufficient_balance`/`400`, `unknown_publisher`/`400` | — | `idempotency_conflict`/`409`, `dependency_not_final`/`409` | — | — | `rate_limited`/`429` | `circuit_digest_mismatch`/`503`, `network_not_ready`/`503` | `internal_error`/`500` |
...
| `AttestBalance` | `malformed_request`/`400` | — | — | `unauthorized`/`401`, `challenge_expired`/`410` | — | `rate_limited`/`429` | `circuit_digest_mismatch`/`503`, `network_not_ready`/`503` | `internal_error`/`500` |
