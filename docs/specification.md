...
Receiver / node:
  ...
  6. amount/asset sanity & issuance terms: confirm coin.recipient = receiver's address and
     ...
     bundle — never credit the coin while silently discarding the terms. For a token-standard-2 asset the
